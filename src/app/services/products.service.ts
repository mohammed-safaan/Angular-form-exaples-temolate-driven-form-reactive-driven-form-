...
export class ProductsService {
  ...
  getProductById(myId: number) {
    console.log(myId);
    return this.productsData.find((product)=> {
      return product.id === myId
    });
  }
  constructor() {}
  setSProduct(product={}){
    this.sProduct.next(product) 
  }
  getSProduct(){
    return this.sProduct.asObservable()
  }
  addProduct(product={}){
